...
from class_statics_config import SCANNET_NYU40_CATEGORIES, ADE20K_CATEGORIES, COLOR_TOLERANCE, LABEL_CHOICE

# ===== 配置区 =====
# INPUT_SCENES_DIR：包含多个场景 PCD 文件的文件夹
# OUTPUT_BASE_DIR：大文件夹，每个场景在其中对应一个子文件夹
# MIN_POINTS_PER_COLOR：过滤掉颜色对应点数过少的簇
if LABEL_CHOICE == "SCANNET_NYU40":
    CATEGORIES = SCANNET_NYU40_CATEGORIES
    # INPUT_SCENES_DIR = Path("/data1/data/scannet/output/pcd_from_ply")
    INPUT_SCENES_DIR = Path("/data1/data/scannet/output_single/pcd_from_ply")
    ...
    INPUT_SCENES_DIR = Path("/data1/user/data/fastlivo_output_qs2_03.17/lidar/res")
    OUTPUT_BASE_DIR = INPUT_SCENES_DIR / "color_separated_scenes"
